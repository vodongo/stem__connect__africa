                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div className="lg:col-span-3 space-y-4">
                        <div className="grid grid-cols-12 gap-4">
                            ...
                            <div className="w-full bg-white rounded-lg shadow-md col-span-12 md:col-span-6 lg:col-span-12" style={{ minHeight: "400px" }}>
                                <Recentactivities user={props.user} />
                            </div>
                        </div>
                    </div>
                    <div className="lg:col-span-6 order-last lg:order-2">
                        ...
                        <div className="py-4">
                            <div className="flex justify-between  items-center mb-3">
                                ...
                                <div>
                                    <select id="blog__filter" name="blog__filter" autoComplete="blog__filter" className="block w-32 rounded bg-gray-100 border border-gray-300 font-medium shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <option>Feed</option>
                                        <option>Week</option>
                                        <option>Month</option>
                    ...
                    <div className="lg:col-span-3 space-y-4 order-2 lg:order-last">
                        <div className="grid grid-cols-12 gap-4">
                            <div className="w-full bg-white  col-span-12 md:col-span-6 lg:col-span-12 rounded-md shadow-md" style={{ minHeight: "300px" }}>
